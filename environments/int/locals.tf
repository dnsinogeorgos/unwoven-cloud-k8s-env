locals {
  ...
  route53_cert_manager_sa_name      = local.service_accounts["route53_cert_manager_role"]["service_account_name"]
  route53_cert_manager_sa_namespace = local.service_accounts["route53_cert_manager_role"]["service_account_namespace"]
  route53_cert_manager_sa_role_arn  = local.service_accounts["route53_cert_manager_role"]["service_account_role_arn"]
